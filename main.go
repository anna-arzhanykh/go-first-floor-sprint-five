...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	caloriesRun := (float64(CaloriesMeanSpeedMultiplier)*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / MInKm * r.Duration.Hours() * MinInHours
	return caloriesRun
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	caloriesWal := (CaloriesWeightMultiplier*w.Weight + math.Pow(w.meanSpeed()*KmHInMsec, 2)/w.Height) * w.Duration.Hours() * float64(MinInHours)
	return caloriesWal
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	caloriesSwim := (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * float64(SwimmingCaloriesWeightMultiplier) * s.Weight * s.Duration.Hours()
	return caloriesSwim
}
